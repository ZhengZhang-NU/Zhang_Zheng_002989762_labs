...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    private void btnProductDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProductDetailsActionPerformed
        ...
        userProcessContainer.add("SupplierWorkAreaJPanel", vpjp);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Please check the quantity field.");
            return;
        }
...
int selectedRowIndex = tblCart.getSelectedRow();
        ...
        ViewOrderItemDetailJPanel vpjp = new ViewOrderItemDetailJPanel(userProcessContainer, item);
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        if (currentOrder == null) {
            currentOrder = new Order(); // create a new order if not already existing
        }
        ...
        /*
 Imagine you have a product with 10 units in stock. A customer adds 3 units to their order. Later, they decide to change this to 5 units.

Initially: oldQuant = 3, available stock = 10.
Temporarily adding back to stock for check: available stock + oldQuant = 10 + 3 = 13.
Checking if 13 (temporary stock) is enough for the new quantity of 5.
If yes, update the available stock: new available stock = 13 - 5 = 8.
Update the order quantity: order quantity = 5.               
         */
